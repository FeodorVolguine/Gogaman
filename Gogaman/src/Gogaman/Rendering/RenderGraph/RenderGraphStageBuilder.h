...
namespace Gogaman
{
	namespace RenderGraph
	{
		...
		public:
			...
			VirtualRenderSurface &CreateRenderSurface(const std::string &name, RenderSurfaceDescriptor &&descriptor);

			VirtualRenderSurface &ReadRenderSurface(const std::string &name);
		private:
			Graph *m_Graph;
			Stage *m_Stage;
		};
